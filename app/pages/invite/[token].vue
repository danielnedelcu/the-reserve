...
const { data: invite, error: loadError } = await useFetch(
  `/api/invites/${token}`,
);
    ...
    <div class="w-full max-w-md">
      ...
      >
        <p class="text-sm text-gray-700">
          {{
            loadError.data?.statusMessage ?? "This invite link is not valid."
          }}
        </p>
      ...
      <div
        v-else
        class="rounded-2xl bg-white p-8 shadow-xl shadow-black/30"
      >
