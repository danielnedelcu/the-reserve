...
| ----------------------------------- | ----------- | ----------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| form_responses_subject              | CHECK       | CHECK ((client_id IS NOT NULL))                                               | Phase 1: the only subject is a client. Phase 2 drops and re-adds this as "exactly one of client_id / prospect_intake_id". Named so that migration can find it. |
