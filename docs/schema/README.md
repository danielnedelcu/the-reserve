...
| [public.clients](public.clients.md)                                             | 25      | Spa clients (no auth accounts). no_show_count is maintained by trigger from appointment status changes. flags is an extensible jsonb for operational booleans (requires_card_on_file).                                                                                                       | BASE TABLE |
